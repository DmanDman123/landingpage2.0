    ...
    <section className="bg-brand-bg-mid px-6 md:px-12 py-32 border-t border-brand-border">
      <div className="max-w-[1140px] mx-auto">
        ...
        >
          ...
          <a 
            href="#analyse" 
            className="inline-flex items-center gap-2 bg-brand-accent text-brand-bg font-instrument text-sm md:text-base font-bold px-8 py-4 no-underline transition-all hover:bg-brand-accent-hover hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(243,177,124,0.25)] active:translate-y-0"
          >
