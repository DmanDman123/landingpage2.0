  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-[100] flex items-center justify-between px-6 md:px-12 py-4 bg-brand-bg/90 backdrop-blur-lg border-b border-brand-border">
      ...
      <div className="flex items-center gap-6">
        ...
        <a 
          href="#analyse" 
          className="bg-brand-accent text-brand-bg font-instrument text-xs md:text-sm font-semibold tracking-wider px-4 md:px-6 py-2.5 no-underline transition-all hover:bg-brand-accent-hover hover:-translate-y-0.5 active:translate-y-0"
        >
